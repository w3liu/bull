...
func init() {
	proto.RegisterType((*Message)(nil), "transport.grpc.Message")
	proto.RegisterMapType((map[string]string)(nil), "transport.grpc.Message.HeaderEntry")
}
...
var fileDescriptor_a97e32c760ec1b28 = []byte{
	...
	,
}
...
func (c *transportClient) Stream(ctx context.Context, opts ...grpc.CallOption) (Transport_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Transport_serviceDesc.Streams[0], "/transport.grpc.Transport/Stream", opts...)
	if err != nil {
		return nil, err
	}
...
var _Transport_serviceDesc = grpc.ServiceDesc{
	ServiceName: "transport.grpc.Transport",
