...
func (g *grpcTransportClient) Recv(m *Message) error {
	if m == nil {
		return nil
	}
...
func (g *grpcTransportClient) Send(m *Message) error {
	if m == nil {
		return nil
	}
...
func (g *grpcTransportSocket) Recv(m *Message) error {
	if m == nil {
		return nil
	}
...
func (g *grpcTransportSocket) Send(m *Message) error {
	if m == nil {
		return nil
	}
