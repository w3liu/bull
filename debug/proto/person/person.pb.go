...
var fileDescriptor_4c9e10cf24b1156d = []byte{
	...
	0xce, 0xcf, 0xd3, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x57, 0x52, 0xe5, 0xe2, 0x0f, 0x4e, 0xac, 0xf4,
	0x48, 0xcd, 0xc9, 0xc9, 0x0f, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x11, 0x12, 0xe2, 0x62, 0xf1,
	0x4b, 0xcc, 0x4d, 0x95, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x02, 0xb3, 0x95, 0x54, 0xb8, 0x04,
	0x10, 0xca, 0x8a, 0x0b, 0xf2, 0xf3, 0x8a, 0x53, 0x85, 0x04, 0xb8, 0x98, 0x73, 0x8b, 0xd3, 0xa1,
	0xca, 0x40, 0x4c, 0x23, 0x6b, 0x2e, 0xb6, 0x00, 0xb0, 0xe1, 0x42, 0x86, 0x5c, 0x1c, 0x30, 0xf5,
	0x42, 0x02, 0x7a, 0x68, 0x36, 0x48, 0x09, 0xea, 0xa1, 0x1b, 0xa6, 0xc4, 0x90, 0xc4, 0x06, 0x76,
	0x90, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xcd, 0xf4, 0x5c, 0xa4, 0xa0, 0x00, 0x00, 0x00,
}
...
func (c *personClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Person/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
