...
func (e *etcdRegistry) Init(opts ...Option) error {
...
func (e *etcdRegistry) registerNode(s *Service, node *Node, opts ...RegisterOption) error {
	if len(s.Nodes) == 0 {
...
func (e *etcdRegistry) Deregister(s *Service, opts ...DeregisterOption) error {
	if len(s.Nodes) == 0 {
		return errors.New("Require at least one node")
	}
...
func (e *etcdRegistry) Register(s *Service, opts ...RegisterOption) error {
	if len(s.Nodes) == 0 {
		return errors.New("Require at least one node")
	}
...
func (e *etcdRegistry) ListServices(opts ...ListOption) ([]*Service, error) {
