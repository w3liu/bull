...
import (
	...
	mgrpc "github.com/w3liu/bull/infra/grpc"
...
func (r grpcRouter) ProcessMessage(ctx context.Context, msg Message) error {
	return r.m(ctx, msg)
}

func (r grpcRouter) ServeRequest(ctx context.Context, req Request, rsp Response) error {
...
func (g *grpcServer) handler(srv interface{}, stream grpc.ServerStream) error {
	...
	if g.opts.Router != nil {
		...
		handler := func(ctx context.Context, req Request, rsp interface{}) error {
			return g.opts.Router.ServeRequest(ctx, req, rsp.(Response))
		}
...
func (g *grpcServer) processRequest(stream grpc.ServerStream, service *service, mtype *methodType, ct string, ctx context.Context) error {
	for {
		...
		fn := func(ctx context.Context, req Request, rsp interface{}) (err error) {
			defer func() {
				if r := recover(); r != nil {
					logger.Error("panic recovered: ", zap.Any("r", r))
...
func (g *grpcServer) NewSubscriber(topic string, sb interface{}, opts ...SubscriberOption) Subscriber {
	return nil
}

func (g *grpcServer) Subscribe(sb Subscriber) error {
	return nil
}
